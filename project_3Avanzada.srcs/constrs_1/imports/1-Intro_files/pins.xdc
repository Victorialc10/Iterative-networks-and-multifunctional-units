...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {num_patterns[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {num_patterns[0]}]
set_property PACKAGE_PIN E19 [get_ports {num_patterns[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {num_patterns[1]}]
set_property PACKAGE_PIN U19 [get_ports {num_patterns[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {num_patterns[2]}]
