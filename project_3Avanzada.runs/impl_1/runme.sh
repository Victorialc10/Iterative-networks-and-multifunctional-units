...
HD_PWD='C:/Users/victo/OneDrive/Documentos/5 ao/TOC/project_3Avanzada/project_3Avanzada.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iterative_1D.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iterative_1D.tcl -notrace
